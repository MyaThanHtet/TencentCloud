...
public class FloatingViewForVideo extends FrameLayout implements GestureDetector.OnGestureListener {
    ...
    TRTCVideoLayoutManager mLayoutManagerTrtcTwo;

    public FloatingViewForVideo(Context context) {
        super(context);
        this.mContext = context;
        this.mGestureDetector = new GestureDetector(context, this);
    }

    public FloatingViewForVideo(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        this.mGestureDetector = new GestureDetector(context, this);
    }

    public FloatingViewForVideo(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mContext = context;
        this.mGestureDetector = new GestureDetector(context, this);
    }

    public FloatingViewForVideo(Context context, int viewResId) {
        super(context);
        this.mContext = context;
        View.inflate(context, viewResId, this);
        mLayoutManagerTrtcTwo=View.inflate(context, viewResId, this).findViewById(R.id.trtc_layout_manager_two_test);
    ...
    public  TRTCVideoLayoutManager floatingTRTCLayoutManager(){
        return mLayoutManagerTrtcTwo;
    }
