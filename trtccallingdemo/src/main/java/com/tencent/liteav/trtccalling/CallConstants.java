...
public class CallConstants {
    ...
    // 刷新、关闭悬浮窗
    public static final String REFRESH_FLOATING = BuildConfig.LIBRARY_PACKAGE_NAME+ "Refresh_Floating";
    public static final String CLOSE_FLOATING = BuildConfig.LIBRARY_PACKAGE_NAME + "Close_Floating";
    // 通话、会议
