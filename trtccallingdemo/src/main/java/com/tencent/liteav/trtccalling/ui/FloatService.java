...
import com.tencent.liteav.trtccalling.CallConstants;
...
public class FloatService extends Service {
    ...
    private void createFloatView() {
        LayoutInflater inflater = LayoutInflater.from(FloatService.this);
        mFloatView = inflater.inflate(R.layout.float_service_layout, null);
        timer = mFloatView.findViewById(R.id.time_for_me);
        ...
        mFloatView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getBaseContext(), TRTCAudioCallActivity.class);
                // 部分设备报错提示要加这个，
