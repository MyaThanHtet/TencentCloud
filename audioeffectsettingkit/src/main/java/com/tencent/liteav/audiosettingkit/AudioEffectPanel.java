...
public class AudioEffectPanel extends FrameLayout {
    ...
    private void initView() {
        ...
        mTvClosePanel = findViewById(R.id.tv_close_panel);
        ...
        mTvActor = findViewById(R.id.tv_actor);
        ...
        mTvBGM = findViewById(R.id.tv_bgm);
        ...
        mBtnSelectedSong = findViewById(R.id.audio_btn_select_song);
        ...
        mIVBGMBack = findViewById(R.id.iv_bgm_back);
        ...
        mMainAudioEffectPanel = findViewById(R.id.audio_main_ll);
        mBGMPanel = findViewById(R.id.audio_main_bgm);

        mRVAudioReverbType = findViewById(R.id.audio_reverb_type_rv);
        mRVAuidoChangeType = findViewById(R.id.audio_change_type_rv);
        mRVAudioBGM = findViewById(R.id.audio_bgm_rv);
    ...
    public class BGMRecyclerViewAdapter extends
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            private void initView(final View itemView) {
                mItemImg = itemView.findViewById(R.id.iv_bgm_play);
                mTitleTv = itemView.findViewById(R.id.tv_bgm_title);
                mTextActor = itemView.findViewById(R.id.tv_bgm_actor);
            }
        }
