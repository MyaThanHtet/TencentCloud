 ...
 * - After receiving the callback of screen sharing, watch screen sharing streams: {@link TRTCCloud#startRemoteView} in {@link TRTCCloudImplListener#onUserVideoAvailable(String, boolean)}}
 *
...
public class ScreenAudienceActvity extends TRTCBaseActivity {
    ...
    private class TRTCCloudImplListener extends TRTCCloudListener {
        ...
        private final WeakReference<ScreenAudienceActvity> mContext;
