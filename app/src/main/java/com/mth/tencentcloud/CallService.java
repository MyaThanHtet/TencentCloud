...
public class CallService extends Service {
    ...
    private final TRTCCallingDelegate mTRTCCallingDelegate = new TRTCCallingDelegate() {
     ...
     /*       Log.i("Call", "incoming call");
            ...
            if (callType == TRTCCalling.TYPE_VIDEO_CALL) {
                TRTCVideoCallActivity.UserInfo selfInfo = new TRTCVideoCallActivity.UserInfo();
                selfInfo.userId = fromUserID;
                selfInfo.userAvatar = "https://liteav.sdk.qcloud.com/app/res/picture/voiceroom/avatar/user_avatar1.png";
                selfInfo.userName = fromUserName;
                TRTCVideoCallActivity.UserInfo callUserInfo = new TRTCVideoCallActivity.UserInfo();
                callUserInfo.userId = toUserID;
                callUserInfo.userAvatar = "https://liteav.sdk.qcloud.com/app/res/picture/voiceroom/avatar/user_avatar2.png";
                callUserInfo.userName = toUserName;
                TRTCVideoCallActivity.startBeingCall(CallService.this, selfInfo, callUserInfo, null);
            } else if (callType == TRTCCalling.TYPE_AUDIO_CALL) {
                TRTCAudioCallActivity.UserInfo selfInfo = new TRTCAudioCallActivity.UserInfo();
                selfInfo.userId = fromUserID;
    ...
    public void onCreate() {
        ...
        fromUserName = prefs.getString("fromUserName", "");
        toUserID = prefs.getString("toUserID", "");
        toUserName = prefs.getString("toUserName", "");
    ...
    private Notification createForegroundNotification() {
        ...
        //通知小图标
        builder.setSmallIcon(R.drawable.ic_baseline_campaign_24);
        //通知标题
...
/*        String userId = ProfileManager.getInstance().getUserModel().userId;
    ...
    private void initMeetingData() {
        ...
        mTRTCMeeting.login(GenerateTestUserSig.SDKAPPID, fromUserID, userSig, new TRTCMeetingCallback.ActionCallback() {
            @Override
            public void onCallback(int code, String msg) {
            }
        });
    ...
    private void initVoiceRoom() {
        ...
        mTRTCVoiceRoom.login(GenerateTestUserSig.SDKAPPID, fromUserID, GenerateTestUserSig.genTestUserSig(fromUserID), (code, msg) -> {
            if (code == 0) {
                mTRTCVoiceRoom.setSelfProfile(fromUserName, "", new TRTCVoiceRoomCallback.ActionCallback() {
                    @Override
                    public void onCallback(int code, String msg) {
                        if (code == 0) {
                        }
