...
public class CustomSettingItem extends BaseSettingItem {
    ...
    public class ItemViewHolder {
        ...
        private final Guideline mLGl;
        private final Guideline mRGl;
        private final Guideline mEndGl;

        public ItemViewHolder(@NonNull final View itemView) {
            rootView = itemView;
            mTitle = itemView.findViewById(R.id.title);
            mItemLl = itemView.findViewById(R.id.ll_item);
            mLGl = itemView.findViewById(R.id.gl_l);
            mRGl = itemView.findViewById(R.id.gl_r);
            mEndGl = itemView.findViewById(R.id.gl_end);
