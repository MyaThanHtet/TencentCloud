...
public class LoginStatusLayout extends ConstraintLayout {
    ...
    private void initView(Context context) {
        ...
        mTextTitle = mRootView.findViewById(R.id.tv_title);
        mTextLoginStatus = mRootView.findViewById(R.id.tv_login_status);
        mImageLoginStatus = mRootView.findViewById(R.id.iv_login_status);
